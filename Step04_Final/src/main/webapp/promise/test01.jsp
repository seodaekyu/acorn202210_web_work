...
<body>
	...
	<script>
		...
		function work(job, callback){ //job을 수행 후에 callback 전달해줘
			...
			setTimeout(function(){
				...
				//callback 안에는 function type이 들어 있다는 가정하에서 해당 함수를 호출한다
				callback();
			}, ranTime);
			
		}
		//자바스크립트에서의 비동기 작업(콜백지옥 이라고도 표현함) 이걸 개선하기위해 promise가 나옴
		work("냉장고 문을 연다", function(){ //냉장고 문을 연 후 함수도 전달
